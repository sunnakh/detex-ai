...
- 🎯 **Calibrated ensemble classifier** — threshold-tuned SVM / XGBoost / LightGBM pipeline
...
- 🐳 **Docker-first** — entire stack (frontend + backend) launches with a single `docker compose up`
